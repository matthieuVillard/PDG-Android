...
public class MergedAppBarLayoutBehavior extends AppBarLayout.ScrollingViewBehavior {
    ...
    public MergedAppBarLayoutBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MergedAppBarLayoutBehavior_Layout);
        setAnchorPoint(a.getDimensionPixelSize(R.styleable.MergedAppBarLayoutBehavior_Layout_behavior_merged_appbar_anchor_point, 0));
        a.recycle();
    }
