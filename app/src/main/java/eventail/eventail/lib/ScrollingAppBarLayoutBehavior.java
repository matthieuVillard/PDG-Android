...
public class ScrollingAppBarLayoutBehavior extends AppBarLayout.ScrollingViewBehavior {
    ...
    public ScrollingAppBarLayoutBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ScrollingAppBarLayoutBehavior_Layout);
        setPeekHeight(a.getDimensionPixelSize(R.styleable.ScrollingAppBarLayoutBehavior_Layout_behavior_scrolling_appbar_peek_height, 0));
        a.recycle();
    }
