...
import eventail.eventail.service.webService.task.users.FriendDeleteTask;
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setTitle(R.string.leave_dialog_title)
                        .setMessage(R.string.msg_friend_delete_confirm)
                        .setPositiveButton(R.string.btn_confirm, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                new FriendDeleteTask(getContext(), new WebTaskHandler<Void>() {
                                    @Override
                                    public void handleSuccess(Void response) {
                                        remove(user);
                                        notifyDataSetChanged();
                                        Toast.makeText(getContext(), getContext().getString(R.string.msg_friend_deleted), Toast.LENGTH_LONG);
                                    }
                                }).execute(user.getId());
                            }
                        })
