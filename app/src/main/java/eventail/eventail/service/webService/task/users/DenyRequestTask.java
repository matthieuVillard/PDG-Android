...
public class DenyRequestTask extends WebTask<Integer, Void> {

    public DenyRequestTask(Context context, WebTaskHandler handler) {
        super(context, handler, "Sending request...");
    }

    public DenyRequestTask(Context context) {
